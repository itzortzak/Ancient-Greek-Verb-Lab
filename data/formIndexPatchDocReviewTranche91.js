(function(){
  ...
  function variants(form){ const out=[form]; if(form.includes('(ν)')){ out.push(form.replace('(ν)','')); out.push(form.replace('(ν)','ν')); } if(form==='μέμασι(ν)'){ out.push('μέμασι'); out.push('μέμασιν'); } return [...new Set(out)]; }
