(function(){
  ...
  const items = [
  {
    ...
    "notes": "Tranche 45: πλήρης ανάπτυξη present/imperfect/future middle layer, με συντηρητική προσθήκη perfect/pluperfect μόνο στα ρητά βεβαιωμένα principal-parts slots."
  }
];
