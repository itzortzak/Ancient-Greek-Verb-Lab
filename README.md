## v1.6.06 / deep philological audit pass 13

- Νέο focused χειροκίνητο φιλολογικό audit σε έξι δύσκολες κατηγορίες ρημάτων: **ἀφίημι, βάλλω, πίνω, πίμπλημι, κρεμάννυμι, φεύγω**.
- Για τα έξι λήμματα προστέθηκε νέο **manual override layer** που υπερισχύει των generated / Kaikki paradigms στην **Κλίση** και στην **Αναγνώριση**.
- Στο **ἀφίημι** καθαρίστηκαν οι competing aorist σειρές και προτιμήθηκε ο σχολικός άξονας **ἀφῆκα / ἀφεῖμεν**, **ἀφείμην**, **ἀφέθην**.
- Στα **βάλλω, πίνω, φεύγω** διορθώθηκαν οι αριθμοπρόσωπες ετικέτες των generated paradigms και αφαιρέθηκαν iterative ή speculative residues.
- Στα **πίμπλημι** και **κρεμάννυμι** συγκρατήθηκαν μόνο οι ασφαλείς source-backed άξονες του σχολικού πυρήνα, με καθαρότερη προβολή future / aorist / perfect.



## v1.6.05 / consistency pass 12

- Καθολικό consistency pass σε **STRICT_AUDIT** και **SLOT_VALIDATIONS** για όλα τα ήδη ενεργά manual paradigms.
- Συμπληρώθηκαν οι λείπουσες audit εγγραφές, συγχρονίστηκαν οι πραγματικοί μετρητές **finite / infinitives / participles**, μηδενίστηκαν τα stale **needsAudit** flags και δημιουργήθηκαν minimal validation anchors όπου έλειπαν.
- Το pass δεν αλλάζει τη φιλολογική ουσία των paradigms· κλείνει μόνο εκκρεμότητες μεταδεδομένων και εσωτερικής συνέπειας.


## v1.6.03 / irregular cleanup pass 6

- Νέο focused cleanup pass για **ῥίπτω, κεράννυμι, λαμβάνω, λανθάνω, μανθάνω, πάσχω, πίπτω, ἀποθνῄσκω**.
- Στο **ῥίπτω** η ορατή Κλίση κρατά πλέον μαζί τους δύο τεκμηριωμένους παθητικούς αορίστους **ἐρρίφθην / ἐρρίφην**.
- Στο **κεράννυμι** κανονικοποιήθηκαν ορατά οι παράλληλοι άξονες **ἐκεράννυν / ἐκεράννυον**, **κεράσω / κερῶ**, **ἐκράθην / ἐκεράσθην**, **κέκραμαι / κεκέρασμαι**.
- Στα **λαμβάνω, λανθάνω, μανθάνω, πάσχω, πίπτω, ἀποθνῄσκω** η προστακτική γ΄ πληθυντικού εμφανίζεται πλέον συμπιεσμένα με τις τεκμηριωμένες διτυπίες **-όντων / -έτωσαν** αντί για χωριστές duplicate γραμμές.

## v1.6.00 / irregular cleanup pass 3

- Νέο focused cleanup pass για **μέμνημαι, ἔοικα, βούλομαι, ἧμαι**.
- Στο **μέμνημαι** η ορατή Κλίση κρατά τώρα τους μονολεκτικούς υποτακτικής/ευκτικής τύπους ως κύριο άξονα, ενώ οι περιφραστικοί μένουν για αναγνώριση.
- Στο **ἔοικα** προτιμήθηκε ο βασικός σχολικός άξονας **ἐοίκασι(ν), εἰκέναι, εἰκώς** και οι μεταγενέστερες ή παράλληλες σειρές **εἴξασι, ἐοικέναι, ἐοικώς** πέρασαν σε recognition-only επίπεδο.
- Στο **ἧμαι** κρατήθηκαν ορατά μόνο οι βασικοί αττικοί τύποι **ἧνται / ἧντο**, ενώ οι επικές παραλλαγές **εἵαται / ἕαται, εἵατο / ἕατο** αφαιρέθηκαν από την ορατή Κλίση.
- Στο **βούλομαι** δεν υπήρχε visible duplication· προστέθηκαν όμως recognition-only οι ρητά τεκμηριωμένες ανώμαλες αυξημένες μορφές **ἠβουλόμην** και **ἠβουλήθην**.
